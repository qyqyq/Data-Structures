...
class arithmeticExpression{
  ...
  public:
    ...
    arithmeticExpression(const string &str):infixExpression(str),root(nullptr){};
 ...
 private:
    ...
    void postfix(TreeNode *rt);

    /* Helper function for generating the dotty file. This is a recursive function. */
    void visualizeTree(ofstream &outputFilename, TreeNode *);
};
#endif
